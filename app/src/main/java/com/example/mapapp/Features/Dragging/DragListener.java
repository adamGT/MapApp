    ...
    public boolean onDrag(View v, DragEvent event) {
        switch (event.getAction()) {
                ...
                switch (viewId) {
                    ...
                    case rvBottom:
                        ...
                        if (viewSource != null) {
                            ...
                            BackCardItem list = adapterSource.getList().get(positionSource);
                            List<BackCardItem> listSource = adapterSource.getList();
                            ...
                            List<BackCardItem> customListTarget = adapterTarget.getList();
                            if (positionTarget >= 0) {
            ...
            case DragEvent.ACTION_DRAG_ENTERED:
                RecyclerView recyclerView = (RecyclerView) v.getRootView().findViewById(R.id.rvTop);
                recyclerView.setBackgroundColor(Color.LTGRAY);
                break;
            case DragEvent.ACTION_DRAG_EXITED:
                RecyclerView rView = (RecyclerView) v.getRootView().findViewById(R.id.rvTop);
