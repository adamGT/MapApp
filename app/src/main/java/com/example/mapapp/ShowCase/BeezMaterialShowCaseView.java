package com.example.mapapp.ShowCase;
...
import com.example.mapapp.Features.ShowCaseView.IDetachedListener;
import com.example.mapapp.Features.ShowCaseView.IShowcaseListener;
import com.example.mapapp.Features.ShowCaseView.PrefsManager;
import com.example.mapapp.R;


public class BeezMaterialShowCaseView extends FrameLayout implements View.OnTouchListener, View.OnClickListener {
    ...
    private BeezMaterialShowCaseView.UpdateOnGlobalLayout mLayoutListener;
    ...
    public BeezMaterialShowCaseView(Activity mActivity) {
        super(mActivity);
        init(mActivity);
    }

    public BeezMaterialShowCaseView(Activity mActivity, AttributeSet attrs) {
        super(mActivity, attrs);
        init(mActivity);
    }

    public BeezMaterialShowCaseView(Activity mActivity, AttributeSet attrs, int defStyleAttr) {
        super(mActivity, attrs, defStyleAttr);
        init(mActivity);
    }

    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    public BeezMaterialShowCaseView(Activity mActivity, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        super(mActivity, attrs, defStyleAttr, defStyleRes);
        init(mActivity);
    }
    ...
    private void init(Activity mActivity) {
        ...
        mLayoutListener = new BeezMaterialShowCaseView.UpdateOnGlobalLayout();
...
//        // Draw the bitmap on our views  canvas.
    ...
    private void applyLayoutParams() {
        ...
        if (mContentBox != null && mContentBox.getLayoutParams() != null) {
            FrameLayout.LayoutParams contentLP = (FrameLayout.LayoutParams) mContentBox.getLayoutParams();
    ...
    public static class Builder {
        ...
        final BeezMaterialShowCaseView showcaseView;
        ...
        public Builder(Activity activity) {
            ...
            showcaseView = new BeezMaterialShowCaseView(activity);
        }

        /**
         * Enforces a user-specified gravity instead of relying on the library to do that.
         */
        public BeezMaterialShowCaseView.Builder setGravity(int gravity) {
         ...
         */
        public BeezMaterialShowCaseView.Builder setTarget(View target) {
            showcaseView.setTarget(new ViewTarget(target));
            return this;
        }

        public BeezMaterialShowCaseView.Builder setSequence(Boolean isSequence) {
         ...
         */
        public BeezMaterialShowCaseView.Builder setDismissText(int resId) {
            return setDismissText(activity.getString(resId));
        }

        public BeezMaterialShowCaseView.Builder setDismissText(CharSequence dismissText) {
            showcaseView.setDismissText(dismissText);
            return this;
        }

        public BeezMaterialShowCaseView.Builder setDismissStyle(Typeface dismissStyle) {
         ...
         */
        public BeezMaterialShowCaseView.Builder setSkipText(int resId) {
            return setSkipText(activity.getString(resId));
        }

        public BeezMaterialShowCaseView.Builder setSkipText(CharSequence skipText) {
            showcaseView.setSkipText(skipText);
            return this;
        }

        public BeezMaterialShowCaseView.Builder setSkipStyle(Typeface skipStyle) {
         ...
         */
        public BeezMaterialShowCaseView.Builder setContentText(int resId) {
         ...
         */
        public BeezMaterialShowCaseView.Builder setContentText(CharSequence text) {
         ...
         * Set the title text shown on the ShowcaseView.
         */
        public BeezMaterialShowCaseView.Builder setTitleText(int resId) {
         ...
         */
        public BeezMaterialShowCaseView.Builder setTitleText(CharSequence text) {
         ...
         * @param toolTip
         */
        public BeezMaterialShowCaseView.Builder setToolTip(ShowcaseTooltip toolTip) {
         ...
         * False by default.
         */
        public BeezMaterialShowCaseView.Builder setTargetTouchable(boolean targetTouchable) {
         ...
         * True by default.
         */
        public BeezMaterialShowCaseView.Builder setDismissOnTargetTouch(boolean dismissOnTargetTouch) {
            showcaseView.setDismissOnTargetTouch(dismissOnTargetTouch);
            return this;
        }

        public BeezMaterialShowCaseView.Builder setDismissOnTouch(boolean dismissOnTouch) {
            showcaseView.setDismissOnTouch(dismissOnTouch);
            return this;
        }

        public BeezMaterialShowCaseView.Builder setMaskColour(int maskColour) {
            showcaseView.setMaskColour(maskColour);
            return this;
        }

        public BeezMaterialShowCaseView.Builder setTitleTextColor(int textColour) {
            showcaseView.setTitleTextColor(textColour);
            return this;
        }

        public BeezMaterialShowCaseView.Builder setContentTextColor(int textColour) {
            showcaseView.setContentTextColor(textColour);
            return this;
        }

        public BeezMaterialShowCaseView.Builder setDismissTextColor(int textColour) {
            showcaseView.setDismissTextColor(textColour);
            return this;
        }

        public BeezMaterialShowCaseView.Builder setDelay(int delayInMillis) {
            showcaseView.setDelay(delayInMillis);
            return this;
        }

        public BeezMaterialShowCaseView.Builder setFadeDuration(int fadeDurationInMillis) {
            showcaseView.setFadeDuration(fadeDurationInMillis);
            return this;
        }

        public BeezMaterialShowCaseView.Builder setListener(IShowcaseListener listener) {
            showcaseView.addShowcaseListener(listener);
            return this;
        }

        public BeezMaterialShowCaseView.Builder singleUse(String showcaseID) {
            showcaseView.singleUse(showcaseID);
            return this;
        }

        public BeezMaterialShowCaseView.Builder setShape(Shape shape) {
            showcaseView.setShape(shape);
            return this;
        }

        public BeezMaterialShowCaseView.Builder withCircleShape() {
            shapeType = CIRCLE_SHAPE;
            return this;
        }

        public BeezMaterialShowCaseView.Builder withOvalShape() {
            shapeType = OVAL_SHAPE;
            return this;
        }

        public BeezMaterialShowCaseView.Builder withoutShape() {
            shapeType = NO_SHAPE;
            return this;
        }

        public BeezMaterialShowCaseView.Builder setShapePadding(int padding) {
            showcaseView.setShapePadding(padding);
            return this;
        }

        public BeezMaterialShowCaseView.Builder setTooltipMargin(int margin) {
            showcaseView.setTooltipMargin(margin);
            return this;
        }

        public BeezMaterialShowCaseView.Builder withRectangleShape() {
            return withRectangleShape(false);
        }

        public BeezMaterialShowCaseView.Builder withRectangleShape(boolean fullWidth) {
            this.shapeType = RECTANGLE_SHAPE;
            this.fullWidth = fullWidth;
            return this;
        }

        public BeezMaterialShowCaseView.Builder renderOverNavigationBar() {
            // Note: This only has an effect in Lollipop or above.
            showcaseView.setRenderOverNavigationBar(true);
            return this;
        }

        public BeezMaterialShowCaseView.Builder useFadeAnimation() {
            showcaseView.setUseFadeAnimation(true);
            return this;
        }

        public BeezMaterialShowCaseView build() {
        ...
        public BeezMaterialShowCaseView show() {
            build().show(activity);
            return showcaseView;
        }
    }
